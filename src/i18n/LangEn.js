export const en = {
  ...
  WLYC:'Network exception, please try again later',
  SCWJDGS:'The file format is incorrect. The file format can only be',
  SCWJDX:'The size of the uploaded file cannot exceed',
  ...
  MUST_BE_5_20:'5 to 20 characters in length',
  ...
  PERONAL_INFO: "Peronal Information",
  ROLE_NAME: "Role Name",
  ...
  PHONE_NO: "Phone No.",
  USER_NAME: "User Name",
  ZQDSJ:'Please enter the correct mobile number',
  ZQDYX:'Please enter the correct email address',
  WJGSCW:'File format error, please upload the image type, such as: JPG, PNG suffix file.',
  JMM: "Old password",
  XMM: "New password",
  ...
  DES:
    "Share Description:<br/>1、The corresponding Share will be deducted according to the Share ratio in their withdrawals;<br/>2、The coupons issued by the organization are borne by the organization, and the platform will deduct the corresponding Share for using the coupons when withdrawing the money.<br/>3、Click the current confirmation and submit successfully. The newly submitted Share rate will take effect, and the historical Share rate will be invalid automatically, and withdrawals after the effective time will be deducted according to the current effective Share rate.",
  ...
  JBTP:'Report picture',
  CKXQ: "View Details",
  JBRS:'Number of reports',
  SFQDYHJY:'Whether to unblock the user',
  JYYH: "Whether to ban the user",
  JYHYH: "The user cannot send messages in the group after the ban",
  JCJYHYH:'The user can send messages within the group after the ban is lifted',
  JSHBK:
    "After disbanding, you can’t restore the group, and no one can send messages in the group.",
  QUN_M: "Group name",
  ...
  ZCGS:'Support format',
  DGWJBN:'A single file cannot exceed 10KB',
  ...
  JGGF:'Agency Official',
  GY: "About us",
  TXMS:'Withdrawal ink',
  DSYHID: "Tip user ID",
  DSYHNC: "Tip user nicknames",
  DSYHYX: "Tip user email",
  KCFBYHID: "Course publishing user ID",
  KCFBYHNC: "Course publishing user nickname",
  KCFBYHYX: "Course publishing user email",
  GMYHID:'Purchase user ID',
  GMYHNC:'Purchase user nickname',
  GMYHYX:'Purchase user email',
  MJ: "Teach on Mespery",
  XGYHSF:'Changing user identity',
  BZ: "Help and Support",
  TK: "Terms of Use",
  YSZC: "Privacy Policy",

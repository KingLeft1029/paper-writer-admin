  ...
  <div class="app-container">
    ...
    <div >
      ...
      <el-table v-loading="loading"   :default-sort = "{prop: 'date', order: 'descending'}" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('COURSE_INK_R')" sortable align="center" width="220"   show-overflow-tooltip="true" prop="userName"
          :show-overflow-tooltip="true" />
        <el-table-column :label="$t('ACTUAL_INK')" sortable align="center" width="130"  show-overflow-tooltip="true" prop="nickName"
          :show-overflow-tooltip="true" />
        <el-table-column :label="$t('SHARE_INK')" sortable align="center" width="220"  show-overflow-tooltip="true" prop="phonenumber" />
        <el-table-column :label="$t('REVENUE_INK')" sortable align="center" width="130"  show-overflow-tooltip="true" prop="phonenumber" />
        <el-table-column :label="$t('COURSE_TITLE')" align="center" width="220" show-overflow-tooltip="true" prop="phonenumber" />
        <el-table-column :label="$t('Tags')"  align="center" width="130" show-overflow-tooltip="true" prop="phonenumber" />
        <el-table-column :label="$t('TYPE_COURSE')"  align="center" width="220" show-overflow-tooltip="true" prop="phonenumber" />
        ...
        <el-table-column :label="$t('Newest')" sortable align="center" width="220" show-overflow-tooltip="true" prop="phonenumber" />
...
export default {
  ...
  methods: {
    ...
    /** 修改按钮操作 */
    handleCheck(row) {
    this.$router.push({path:'/finance/coursedetail',query:{id:1}})
    },

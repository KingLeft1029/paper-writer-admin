  ...
  <div class="app-container">
    ...
    <div >
      ...
      <el-table v-loading="loading"   :default-sort = "{prop: 'date', order: 'descending'}" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('COURSE_INK_R')" sortable align="center" key="userName" prop="userName"
          :show-overflow-tooltip="true" />
        <el-table-column :label="$t('ACTUAL_INK')" sortable align="center" key="nickName" prop="nickName"
          :show-overflow-tooltip="true" />
        ...
        <el-table-column :label="$t('COURSE_TITLE')" align="center" key="phonenumber" prop="phonenumber" />

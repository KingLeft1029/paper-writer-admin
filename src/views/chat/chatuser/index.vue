  ...
  <div class="app-container">
    ...
    <el-form  :model="queryParams" ref="queryForm"
      ...
      <el-form-item  prop="userName">
        <el-input v-model="queryParams.userName" :placeholder="$t('用户ID')" clearable  style="width: 220px"
    ...
    <div >
      ...
      <el-table v-loading="loading"   :default-sort = "{prop: 'date', order: 'descending'}" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('SER_NUM')" sortable align="center" key="userName" prop="userName"
        ...
        <el-table-column :label="$t('Country')" align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('Phone')" sortable align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('Birthday')" sortable align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('Age')" sortable align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('IDENTIFY')" sortable align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('JQRQ')" sortable align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('Status')" sortable align="center" key="phonenumber" prop="phonenumber" />

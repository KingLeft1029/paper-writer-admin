  ...
  <div class="app-container">
    ...
    <div  >
      ...
      <el-table v-loading="loading"   :default-sort = "{prop: 'date', order: 'descending'}" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('COURSE_TITLE')" align="center" key="nickName" prop="nickName"
          :show-overflow-tooltip="true" />
          <el-table-column :label="$t('TYPE_COURSE')" align="center" key="phonenumber" prop="phonenumber" />
        ...
        <el-table-column :label="$t('S_name')" align="center" key="phonenumber" prop="phonenumber" />


        <el-table-column :label="$t('R_ID')" align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('USE_COUPONS')" align="center" key="phonenumber" prop="phonenumber" />
        ...
        <el-table-column :label="$t('REGIST_TIME')"  align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('Status')" align="center" key="status">
          <template slot-scope="scope">
            {{ scope.row.status == "0" ? $t("ENABLE") : $t("DISABLE") }}
          </template>
        </el-table-column>
        <el-table-column :label="$t('PAY_TIME')"  align="center" key="phonenumber" prop="phonenumber" />
...
export default {
  ...
  methods: {
    ...
    handleCheck(row) {
     ...
     this.$router.push({path:'/content/checkorder',query:{id:1}})
    },

  ...
  <div class="app-container">
    ...
    <div  >
      ...
      <el-table v-loading="loading"   :default-sort = "{prop: 'date', order: 'descending'}" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('Cover')" align="center" key="phonenumber" prop="phonenumber" >
        ...
        <el-table-column :label="$t('PAYMENT_TYPE')" align="center" key="phonenumber" prop="phonenumber" />
...
this.$router.push({path:'/content/checkcourse',query:{id:1}})
    ...
    handleAudit(){
      this.$router.push({path:'/content/auditcourse',query:{id:1}})
},
  },
};
</script>

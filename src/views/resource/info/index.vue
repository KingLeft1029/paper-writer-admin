  ...
  <div class="app-container">
    ...
    <div>
      ...
      <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('PTXX')" align="center" key="nickName" prop="nickName"
          :show-overflow-tooltip="true" />

        <el-table-column :label="$t('Operators')" align="center" key="phonenumber" prop="phonenumber" />
        <el-table-column :label="$t('CREATION_TIME')" align="center" key="deptName" prop="dept.deptName" />
        <el-table-column :label="$t('Operate')" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-view" @click="handleDelete(scope.row)">{{
              $t("View") }}</el-button>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form label-position="right" ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="24">
            <el-form-item  :label="$t('PTXX')" prop="userName">
             {{$t('JG')}}
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item :label="$t('Content')" prop="nickName">
              <editor ></editor>
            </el-form-item>
          </el-col>

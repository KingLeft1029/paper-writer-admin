  ...
  <div class="app-container">
    ...
    <div  >
      ...
      <el-table v-loading="loading"   :default-sort = "{prop: 'date', order: 'descending'}" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column :label="$t('Title')" align="center" key="userName" prop="userName"
          :show-overflow-tooltip="true" />
        <el-table-column :label="$t('Tags')" align="center" key="nickName" prop="nickName"
          :show-overflow-tooltip="true" />
        ...
        <el-table-column :label="$t('Inkjet')" sortable align="center" key="deptName" prop="dept.deptName" />



        <el-table-column :label="$t('REWARD_TIME')" sortable align="center" key="deptName" prop="dept.deptName" />
